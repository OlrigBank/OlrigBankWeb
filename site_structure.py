menus = [
    {"menu": "Home", "parent": None, "text": "Welcome to Kendal the home of Olrig Bank"},
    {"menu": "Whats On", "parent": "Home", "text": "Links to sites that will keep you abreast better than we can as to what is happening locally"},
    {"menu": "Local", "parent": "Home", "text": "Olrig Bank's recommended local delights"},
    {"menu": "Eating Out", "parent": "Local", "text": "Places we where we love to eat" },
    {"menu": "Local Walks", "parent": "Local", "text": "Good walks to take close to the house" },
    {"menu": "Activities", "parent": "Local", "text": "A wide variety of local activities"},
]
